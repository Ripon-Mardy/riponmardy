        ...
        <div className="mt-5 grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-md p-4 bg-gray-50 space-y-4">
            ...
            <p className="text-gray-800 text-sm">
              🎯 Full-Stack Portfolio with Admin Dashboard • Frontend: Next.js
              14+ with Tailwind CSS • Backend: API Routes with MongoDB database
              • Admin Panel: Complete CMS for content management • Features:
              Dyna…
            </p>
            <div>
