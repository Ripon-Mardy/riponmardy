    ...
    <div className="max-w-6xl mx-auto py-10 p-4 mt-5">
      <div className="grid grid-cols-1 md:grid-cols-[65%_35%] gap-6">
        ...
        <div className="space-y-8">
          ...
          <span className="mt-4 inline-block text-lg font-light text-gray-800">
            2+ years
          </span>
          {/* expericence  */}
          <div className="space-y-10">
            ...
            <div className="space-y-2">
              ...
              <span className="text-gray-700 font-normal block">
                Freelance / upwork, fiver , remote
              </span>
