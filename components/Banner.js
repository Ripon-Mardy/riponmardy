      ...
      <div className="flex items-start justify-start gap-10 md:gap-0 md:space-x-10 px-4 md:flex-row flex-col">
        ...
        <div className="text-left mt-5">
          <div className="space-y-3">
            <h2 className="text-3xl md:text-6xl font-semibold relative flex">
              Hi, I'm Ripon Mardy
            ...
            <p className="text-lg md:text-2xl">
              I <strong>design</strong>, <strong>code</strong>, and{" "}
              <strong>deploy</strong> things that live on the web.
            </p>
          </div>
          {/* “I’m Interested In” */}
          <div className="mt-16">
            ...
            <div className="space-y-2 mt-3">
              ...
              <p className="text-lg">
                * Writing code that’s clean, clear, and scalable
              </p>
            </div>
          </div>
        </div>
