  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-6">
        ...
        {/* Carousel Card */}
        <div className="relative min-h-[160px] bg-[#212123]/60 border border-[#303031] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-5 items-center md:items-start shadow-md overflow-hidden">
