            ...
            <aside className="md:w-1/3 bg-gradient-to-b from-white to-gray-100 p-6 md:p-8">
              ...
              <div className="mt-6">
                ...
                <p className="mt-2 text-sm text-gray-700">
                  Motivated full stack developer with 2 year of remote
                  experience and freelance work. I build responsive, scalable
                  web apps and enjoy learning new technologies and improving
                  processes.
                </p>
              </div>
            ...
            <section className="md:flex-1 p-6 md:p-8">
              ...
              <div className="mt-6 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="pl-3 mt-3">
                        <ul className="list-disc space-y-1">
                          ...
                          <li className="text-sm text-gray-700">
                            Integrated and consumed REST APIs to support
                            real-time data updates.
                          </li>
                          <li className="text-sm text-gray-700">
                            Worked with authentication, form handling, and
                            secure data storage.
                          </li>
                          <li className="text-sm text-gray-700">
                    ...
                    <div>
                      ...
                      <div className="pl-3 mt-3">
                        <ul className="list-disc space-y-1">
                          ...
                          <li className="text-sm text-gray-700">
                            Converted client ideas into working UI with clean
                            and modern design.
                          </li>
                          <li className="text-sm text-gray-700">
                ...
                <div>
                  ...
                  <hr />
                  <div className="mt-3">
                    <p className="text-sm text-gray-700">Diploma in CSE</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ul className="mt-3 list-disc list-inside text-sm text-gray-700">
                    <li>
                      Completed several real-world client projects as a
                      freelancer
                    </li>
                    <li>
              ...
              <div className="mt-8 flex gap-3">
                ...
                <button
                  ...
                  onClick={() => window.open("/resume_of_ripon_mardy.pdf")}
                >
                  Download PDF
                </button>
              </div>
